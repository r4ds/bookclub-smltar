...
```{r echo=FALSE, out.width = "100%", message=TRUE, warning=FALSE, paged.print=FALSE}
...
- it’s better to keep these words and do some tests with and without them so see how it affects the model and you should never remove stop words without thinking about the impact of these words on the problem you are trying to solve.
...
```{r, eval=knitr:::is_html_output(), echo=TRUE, results='markup'}
tidy_fir_tree %>%
