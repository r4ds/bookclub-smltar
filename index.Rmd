--- 
title: "Supervised Machine Learning for Text Analysis in R Book Club"
...
link-citations: yes
github-repo: r4ds/bookclub-smltar
description: "This is the product of the R4DS Online Learning Community's Supervised Machine Learning for Text Analysis in R Book Club."
---
...
This is a companion for the book [_Supervised Machine Learning for Text Analysis in R_](https://smltar.com/) by Emil Hvitfeldt and Julia Silge (Chapman and Hall/CRC, copyright 2021, [9781003093459](https://doi.org/10.1201/9781003093459)).
This companion is available at [r4ds.io/smltar](https://r4ds.io/smltar).
...
- More information about how to present is available in the [github repo](https://github.com/r4ds/bookclub-smltar).
